...
-- Of course, this is just used for Scorpions scripthub. or just used for my CMD-X Remake.
...
return {Classes = classes, Enums = enums, PropertyOrders = propertyOrders}
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{6,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Desc",Parent={3},Position=UDim2.new(0,-230,0,60),Size=UDim2.new(0,180,0,25),Text="Thanks for using CMD-XR!",TextColor3=Color3.new(1,1,1),TextSize=18,TextTransparency=1,}},
